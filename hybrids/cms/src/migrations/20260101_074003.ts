...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_authors_role" AS ENUM('guestWriter', 'staffWriter', 'contributor', 'editor');
  ...
  CREATE TABLE "authors" (
  	...
  	"role" "enum_authors_role" DEFAULT 'staffWriter' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE UNIQUE INDEX "blog_posts_title_idx" ON "blog_posts" USING btree ("title");
